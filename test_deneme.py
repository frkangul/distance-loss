from src.data.customDatasets import CityscapesToSmpDataset
import cv2
    ...
    transforms = {
        "train": A.Compose(
            [
                ...
                A.PadIfNeeded(
                    min_height=512, min_width=512, border_mode=cv2.BORDER_REFLECT_101
                ),
                A.Normalize(
...
test_ds = CityscapesToSmpDataset(
    "/home/frkangul/distance-loss/data/cityscapes",
    split="test",
    mode="fine",
